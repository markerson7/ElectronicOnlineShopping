...
public class ElectronicOnlineShopping {
    ...
    public static void main(String[] args) {
        ...
        shopping.addBoughtProduct("Nova Body Cream", 0233434566, 75.00, 80.00);
        shopping.addBoughtProduct("Lush Hair", 0233434576, 100.00, 110.00);
        shopping.addBoughtProduct("Perfume", 0233434586, 105.00, 110.00);
        ...
        shopping.addSoldProduct("Perfume", 0233434586, 105.00, 175.00);
